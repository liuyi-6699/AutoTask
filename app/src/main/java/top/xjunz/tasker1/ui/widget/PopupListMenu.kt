...
package top.xjunz.tasker1.ui.widget
...
import top.xjunz.tasker1.databinding.ItemMenuBinding
import top.xjunz.tasker1.databinding.LayoutMenuListBinding
import top.xjunz.tasker1.ktx.resolvedId
import top.xjunz.tasker1.ui.main.ColorScheme
import top.xjunz.tasker1.util.ClickListenerUtil.setNoDoubleClickListener
import top.xjunz.tasker1.util.ReflectionUtil.invokeSuperMethod

/**
 * @author Mengran 2022/12/10
 */
class PopupListMenu @JvmOverloads constructor(
    ...
    private inner class MenuItemViewHolder(val binding: ItemMenuBinding) :
        ...
        init {
            binding.content.setNoDoubleClickListener {
