...
import top.xjunz.tasker1.ktx.attrColor
import top.xjunz.tasker1.ktx.attrColorStateList
...
object ColorScheme {
    ...
    @get:ColorInt
    val colorError: Int
        get() = getAttrColor(R.attr.colorError)
    ...
    val colorTertiaryContainer: Int
        get() = getAttrColor(R.attr.colorTertiaryContainer)
    ...
    val colorOnSurface: Int
        get() = getAttrColor(R.attr.colorOnSurface)

    @get:ColorInt
    val colorSurface: Int
        get() = getAttrColor(R.attr.colorSurface)

    @get:ColorInt
    val colorPrimaryContainer
        get() = getAttrColor(R.attr.colorPrimaryContainer)
}